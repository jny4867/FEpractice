...
// function getMovies() {
//     axios
//     .get('https://www.omdbapi.com/?apikey=7a75fcd7&s=frozen')
//     .then((response) => {
...
var API_KEY = '4f6d596b596a6e793132374b6e5a6356';
function getData() {
  return _getData.apply(this, arguments);
}
function _getData() {
  _getData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var url, response, data, locations;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          url = "http://openapi.seoul.go.kr:8088/".concat(API_KEY, "/json/bikeList/1/5/");
          _context.prev = 1;
          _context.next = 4;
          return fetch(url);
        case 4:
        ...
        case 7:
          data = _context.sent;
          locations = data.rentBikeStatus.row.map(function (spot) {
            return [spot.stationName, spot.stationLatitude, spot.stationLongitude, spot.parkingBikeTotCnt];
          });
          console.log(data);
